...
module.exports = function(app) {
     ...
     */
    app.get('regions/get', function (req, res) {
    ...
    app.get('regions/aggregate', function (req, res) {
    ...
    app.get('regions/aggregateRegion', function (req, res) {
      var region = req.query.region;
    ...
    app.get('regions/aggregateLinks', function (req, res) {
      var n1 = req.query.n1;
      var n2 = req.query.n2;
